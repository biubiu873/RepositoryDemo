						...
						<div class="top_menu">
							...
							<div class="profile_details_left">
								...
								<ul class="nofitications-dropdown">
									...
									<li class="dropdown note">
											<a href="/jsp/RegisterAndLogIn.jsp" style="text-align:center; color: #fff;font-size: 16px;">登录/注册</a>
										</div>
									</li>
...
<!--		======================================		正文			==============================================				-->
					...
					<iframe src="/jsp/QuestionAndAnswer.jsp" frameborder="0" scrolling="yes" height="100%" width="100%"></iframe>
